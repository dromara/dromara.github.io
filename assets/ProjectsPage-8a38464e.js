...
<a href="https://gitee.com/link?target=https%3A%2F%2Fshang.qq.com%2Fwpa%2Fqunwpa%3Fidkey%3D2e9e353fa10924812bc58c10ab46de0ca6bef80e34168bccde275f7ca0cafd85"><img src="https://img.shields.io/badge/chat-on%20QQ-ff69b4.svg?style=flat-square" alt="QQ群"></a></p>`}]},{groupName:t.POPULAR_TOOLS,projects:[{name:"hutool",website:"https://hutool.cn/",description:t.HUTOOL_DESC,sponsor:"Looly（loolly_admin）",date:"2021.03",link:`
  ...
  <a href="https://gitee.com/link?target=https%3A%2F%2Fgithub.com%2Fdromara%2Fjinx%2Fblob%2Fmaster%2FLICENSE"><img src="https://img.shields.io/github/license/dromara/jinx.svg?style=flat-square"></a>
          `},{name:"WeMQ",website:"https://wemq.nicholasld.cn/",description:t.WEMQ_DESC,sponsor:"NicholasLD（nicholasld）",date:"2023.09",link:`
...
`}]}]);return t.DISTRIBUTED_TRANSACTION,t.DISTRIBUTED_SCHEDULING,(g,h)=>(s(),r(u,null,[a("div",H,[a("div",Y,[a("div",Q,[a("h1",V,o(b(t).PROJECTS),1),a("p",K,o(b(t).DESCRIPTION),1)])])]),a("main",W,[(s(!0),r(u,null,k(F.value,c=>(s(),r("div",{key:c.groupName,class:"project-group"},[a("h2",X,o(c.groupName),1),a("div",Z,[(s(!0),r(u,null,k(c.projects,e=>(s(),r("div",{class:"project",key:e.name},[a("div",$,[a("div",tt,[v(e.name)?(s(),r("div",at,o(y(e.name)),1)):(s(),r("img",{key:0,class:"project-title",src:`/assets/img/logo/${e.name}.png`,alt:e.name},null,8,et)),a("div",st,[m.value=="zh-CN"||m.value=="/zh/"?(s(),r(u,{key:0},[_.includes(e.name)?l("v-if",!0):(s(),r("a",{key:0,href:`https://gitee.com/dromara/${e.name}/stargazers`,target:"_blank"},[a("img",{src:`https://gitee.com/dromara/${e.name}/badge/star.svg?theme=gvp`},null,8,it)],8,rt))],64)):(s(),r(u,{key:1},[S.includes(e.name)?l("v-if",!0):(s(),L(b(z),{key:0,project:e.name},null,8,["project"]))],64))])]),a("div",ot,o(e.description),1)]),a("div",gt,[e.sponsor?(s(),r("p",mt,o(b(t).PROJECT_SPONSOR)+"："+o(e.sponsor),1)):l("v-if",!0),e.date?(s(),r("p",ht,o(b(t).JOINING_DATE)+"："+o(e.date),1)):l("v-if",!0),a("p",{innerHTML:e.link},null,8,ct)]),a("div",lt,[a("a",{class:"project-button primary",href:e.website},o(b(t).START_UP),9,nt),_.includes(e.name)?l("v-if",!0):(s(),r("a",{key:0,class:"project-button",target:"_blank",href:`https://gitee.com/dromara/${e.name}`},"Gitee",8,dt)),S.includes(e.name)?l("v-if",!0):(s(),r("a",{key:1,class:"project-button",target:"_blank",href:`https://github.com/dromara/${e.name}`},"Github",8,pt))])]))),128))])]))),128))])],64))}});const Ft=D(bt,[["__scopeId","data-v-d3e7c14a"],["__file","ProjectsPage.vue"]]);export{Ft as P};
