...
<span class="line"><span>    }).toList();</span></span>
<span class="line"><span>//from user left join company on ... where user.name like ? and company.name like ?</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="一对多隐式子查询" tabindex="-1"><a class="header-anchor" href="#一对多隐式子查询"><span>一对多隐式子查询</span></a></h5><blockquote><p>当我们在用户对象里面创建好企业关系可以在筛选用户时使用企业作为条件,反之我们在企业模型里面创建好企业和用户的关系我们在筛选企业的时候一样可以使用用户作为条件帮我们快速实现筛选</p></blockquote><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>//筛选企业,筛选条件为企业下的员工存在名字是小明的</span></span>
...
<span class="line"><span>    }).toList();</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="多表显式join" tabindex="-1"><a class="header-anchor" href="#多表显式join"><span>多表显式join</span></a></h5><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
...
<span class="line"><span>//select company.* from user left join company on user.company_id = company.id where company.name like ?</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="直接获取用户拥有的菜单" tabindex="-1"><a class="header-anchor" href="#直接获取用户拥有的菜单"><span>直接获取用户拥有的菜单</span></a></h5><blockquote><p>用户和菜单并没有直接关系中间和角色表是多对多中间还有两张表user_role和role_menu表</p></blockquote><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>//查询小明用户拥有的菜单id集合</span></span>
...
<span class="line"><span>    .where(user -&gt; user.name().eq(&quot;小明&quot;))</span></span>
<span class="line"><span>    .toList(user -&gt; user.roles().flatElement().menus().flatElement());</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="返回用户结构附带角色" tabindex="-1"><a class="header-anchor" href="#返回用户结构附带角色"><span>返回用户结构附带角色</span></a></h5><blockquote><p>返回结果</p></blockquote><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>{user:{id:xxx,roles:[{...}]}}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>//返回小于18岁的用户并且附带角色</span></span>
...
<span class="line"><span>      )).toList();</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="结构化dto" tabindex="-1"><a class="header-anchor" href="#结构化dto"><span>结构化DTO</span></a></h3><p>很多时候我们在访问响应时需要返回自定义的数据结构,而不是整个数据库结构</p><p>所以我们这边使用easy-query插件来快速实现构建结构化DTO响应</p><ul><li><p>首先我们在idea插件市场安装<code>EasyQueryAssistant</code>插件最新版本</p></li><li><p>第二部在需要创建DTO的包右键CreateStructDTO</p></li><li><p>第三步选择需要返回的结构化数据</p><figure><img src="`+p+'" alt="" tabindex="0"><figcaption></figcaption></figure><figure><img src="'+t+`" alt="" tabindex="0"><figcaption></figcaption></figure></li></ul><blockquote><p>最终会生成如下dto</p></blockquote><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
<span class="line"><span>/**</span></span>
...
<span class="line"><span>//参数:2024-05-20T14:40:08.152(LocalDateTime),86400000000(Long),2024-01-01 00:00:00(String)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果您对此框架有兴趣那么欢迎您的尝试，也欢迎您的意见建议,框架拥有太多的功能无法在这里意义展示,更多的功能可以访问 github仓库 或gitee仓库 进行查阅</p><h3 id="最后" tabindex="-1"><a class="header-anchor" href="#最后"><span>最后</span></a></h3><p><code>easy-qeury</code>很高兴加入dromara这个组织希望可以再组织下茁壮成长,为java开源贡献一份自己的微弱力量</p><p>最后附上项目地址欢迎大家加入star提交pr issue</p><p>github仓库 https://github.com/dromara/easy-query</p><p>gitee仓库 https://gitee.com/dromara/easy-query</p>`,58)])])}const o=n(r,[["render",d]]),m=JSON.parse('{"path":"/zh/news/EasyQuery.html","title":"欢迎现代化 Java ORM Easy-Query 加入 Dromara社区","lang":"zh-CN","frontmatter":{"title":"欢迎现代化 Java ORM Easy-Query 加入 Dromara社区","author":"xuejm","date":"2024-05-27T00:00:00.000Z","cover":"/assets/img/news/EasyQuery-0.png","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"欢迎现代化 Java ORM Easy-Query 加入 Dromara社区\\",\\"image\\":[\\"https://vuepress-theme-hope-docs-demo.netlify.app/assets/img/news/EasyQuery-0.png\\",\\"https://vuepress-theme-hope-docs-demo.netlify.app/assets/img/news/EasyQuery-1.jfif\\",\\"https://vuepress-theme-hope-docs-demo.netlify.app/assets/img/news/EasyQuery-2.jfif\\"],\\"datePublished\\":\\"2024-05-27T00:00:00.000Z\\",\\"dateModified\\":\\"2025-08-02T07:22:01.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"xuejm\\"}]}"],["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/zh/news/EasyQuery.html"}],["meta",{"property":"og:title","content":"欢迎现代化 Java ORM Easy-Query 加入 Dromara社区"}],["meta",{"property":"og:description","content":"作者介绍 名称:xuejm dromara 开源组织成员,dromara/easy-query 作者 java/.net相关开发10年以上经验小菜鸟一枚 爱好开源技术乐于专研分享,拥有多个开源项目O(∩_∩)O哈哈~ 个人空间:https://github.com/xuejmnet 和 https://gitee.com/xuejm 前言 ORM又叫对..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://vuepress-theme-hope-docs-demo.netlify.app/assets/img/news/EasyQuery-0.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:locale:alternate","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2025-08-02T07:22:01.000Z"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:src","content":"https://vuepress-theme-hope-docs-demo.netlify.app/assets/img/news/EasyQuery-0.png"}],["meta",{"name":"twitter:image:alt","content":"欢迎现代化 Java ORM Easy-Query 加入 Dromara社区"}],["meta",{"property":"article:author","content":"xuejm"}],["meta",{"property":"article:published_time","content":"2024-05-27T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2025-08-02T07:22:01.000Z"}],["link",{"rel":"alternate","hreflang":"en-us","href":"https://vuepress-theme-hope-docs-demo.netlify.app/news/EasyQuery.html"}],["meta",{"name":"新闻"}]],"description":"作者介绍 名称:xuejm dromara 开源组织成员,dromara/easy-query 作者 java/.net相关开发10年以上经验小菜鸟一枚 爱好开源技术乐于专研分享,拥有多个开源项目O(∩_∩)O哈哈~ 个人空间:https://github.com/xuejmnet 和 https://gitee.com/xuejm 前言 ORM又叫对..."},"git":{"createdTime":1723712940000,"updatedTime":1754119321000,"contributors":[{"name":"itanxyu","username":"itanxyu","email":"itanxy@126.com","commits":3,"url":"https://github.com/itanxyu"},{"name":"kaku","username":"kaku","email":"1092804319@qq.com","commits":1,"url":"https://github.com/kaku"}]},"readingTime":{"minutes":9.01,"words":2703},"filePathRelative":"zh/news/EasyQuery.md","autoDesc":true}');export{o as comp,m as data};
