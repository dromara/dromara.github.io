import{_ as e,a as i,b as n,c as a}from"./warm-flow-v1.2.8-3-4ae5df61.js";import{_ as l}from"./qrcode_zsxq-8eef4d18.js";import{_ as s,o as r,c as d,f as t}from"./app-57280697.js";const c={},v=t('<h1 id="warm-flow-1-2-8版本更新-新增办理人变量表达式和条件表达式支持spel" tabindex="-1"><a class="header-anchor" href="#warm-flow-1-2-8版本更新-新增办理人变量表达式和条件表达式支持spel" aria-hidden="true">#</a> warm-flow 1.2.8版本更新,新增办理人变量表达式和条件表达式支持spel</h1><figure><img src="'+e+`" alt="" tabindex="0"><figcaption></figcaption></figure><ul><li><p>【升级注意事项】</p></li><li><p>本次升级，内置json库snack3方式，改为spi方式加载，业务项目中存在哪种json就会使用哪种的实现， 支持顺序按顺序加载一种：snack3、jackson、fastjson、gson，并且目前只实现了这四种，可扩展</p></li><li><p>如在未集成snack3库的环境下，还需要使用snack3库，需要单独使用（原组件使用snack3库）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>      &lt;dependency&gt;
