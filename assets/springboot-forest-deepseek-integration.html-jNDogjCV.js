import{_ as n,a as e,b as a}from"./springboot-forest-deepseek-integration-2-Bd7faMpN.js";import{_ as i,c as p,a as l,o as t}from"./app-DeSWVaLF.js";const c={};function d(r,s){return t(),p("div",null,[...s[0]||(s[0]=[l(`<h2 id="一-环境要求" tabindex="-1"><a class="header-anchor" href="#一-环境要求"><span>一. 环境要求</span></a></h2><ul><li><p>JDK 8 / 17</p></li><li><p>SpringBoot 2.x / 3.x</p></li><li><p>Forest 1.6.4+</p></li><li><p>Fastjson2</p></li></ul><h3 id="依赖配置" tabindex="-1"><a class="header-anchor" href="#依赖配置"><span>依赖配置</span></a></h3><p>除了 SpringBoot 和 Lombok 等基础框架之外，再加上 Forest 和 Fastjson2 的依赖</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>&lt;!-- Forest框架 --&gt;</span></span>
